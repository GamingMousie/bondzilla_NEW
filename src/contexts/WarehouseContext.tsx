...
export const WarehouseProvider = ({ children }: { children: ReactNode }) => {
  ...
  const addLoad = useCallback((loadData: LoadFormData) => {
    const newLoad: Load = {
      ...
      arrivalDate: loadData.arrivalDate ? (loadData.arrivalDate as unknown as string) : undefined,
      storageExpiryDate: loadData.storageExpiryDate ? (loadData.storageExpiryDate as unknown as string) : undefined,
